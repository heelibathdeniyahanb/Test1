...
import CustomerSupporterCard1 from '../../Components/CustomerSupporter/DashboardComponents/CustomerSupporterCard1';
import CustomerSupporterCard2 from '../../Components/CustomerSupporter/DashboardComponents/CustomerSupporterCard2';
      ...
      <div className="flex flex-col md:flex-row">
        ...
        <div className="flex flex-col w-full md:w-3/4 p-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
           <CustomerSupporterCard1/>
            <CustomerSupporterCard2/>
